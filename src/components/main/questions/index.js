    ...
    return (
      <div className="questions">
        <div className="questions__container">
          <h5 className="questions__header">There are probably a few questions you have for me after looking at my r&eacute;sum&eacute;. I would like to address some of those below.</h5>
          ...
          <div>
            <div className="answers">
              ...
              <div className={`answers__item ${this.state.a2}`}>
                ...
                well. So I thought to myself, “Hey! you can do this too!” So I gave a 30-day notice to my company, sold all of my belongings, and moved up to Orange County. It turned out that working
